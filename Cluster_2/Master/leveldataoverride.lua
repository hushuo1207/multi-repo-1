return {
  custom_settings_desc="常用",
  custom_settings_id="CUSTOM_AXING",
  custom_settings_name="axing",
  custom_worldgen_desc="常用",
  custom_worldgen_id="CUSTOM_AXING",
  custom_worldgen_name="axing",
  desc="标准《饥荒》体验。",
  hideminimap=false,
